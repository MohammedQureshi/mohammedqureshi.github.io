    ...
    return(
        <div className="about-me">
            ...
            <div className="information-area">
                ...
                <Experience logo={yozu} jobtitle="Software Engineer" company="Yozu - Full-Time" dateworked="June 2021 - Present" location="North West, England, United Kingdom" description="As a Software Developer I will be working with Ruby on Rails and React JS, Currently just starting this role so will update further into the role."/>
